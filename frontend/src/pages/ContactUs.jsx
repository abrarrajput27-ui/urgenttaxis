          ...
          <div className="pt-6 border-t border-gray-200 mt-6">
            ...
            <div className="flex flex-col space-y-3">
              <a 
                ...
                className="inline-flex items-center text-gray-700 hover:text-[#1877F2] transition-colors font-medium text-sm"
              >
                <FacebookIcon className="w-5 h-5 mr-3 text-[#1877F2]" /> Urgent Taxis on Facebook
              </a>
              <a 
              ...
              >
                <InstagramIcon className="w-5 h-5 mr-3 text-[#E1306C]" /> @urgent.taxis on Instagram
              </a>
              <a 
                href="https://www.youtube.com/@urgenttaxis" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center text-gray-700 hover:text-[#FF0000] transition-colors font-medium text-sm"
              >
                <YoutubeIcon className="w-5 h-5 mr-3 text-[#FF0000]" /> @urgenttaxis on YouTube
              </a>
            </div>
          </div>
      </div>
