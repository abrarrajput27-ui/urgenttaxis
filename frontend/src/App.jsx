  ...
  return (
    <div className="font-sans text-gray-800 bg-white min-h-screen">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-50">
        <a 
          href={`tel:${CALL_NUMBER}`}
          className="bg-[#1e3a8a] hover:bg-[#152e73] text-white p-[14px] rounded-full shadow-2xl transition-transform transform hover:scale-110 flex items-center justify-center border-4 border-blue-100/50"
        >
          <Phone className="w-7 h-7 fill-current" />
        </a>
        <button 
          onClick={() => handleSimpleWhatsApp('Hi Urgent Taxis, I need some help.')}
          className="bg-[#00a859] hover:bg-[#00904d] text-white p-[14px] rounded-full shadow-2xl transition-transform transform hover:scale-110 flex items-center justify-center border-4 border-green-100/50"
        >
