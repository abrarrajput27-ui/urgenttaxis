  ...
  return (
    <div className="font-sans text-gray-800 bg-white min-h-screen">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <div className="flex items-center">
              ...
              <div className="flex flex-col">
                <a href={`tel:${CALL_NUMBER}`} className="font-black text-[18px] text-[#1e3a8a] leading-tight tracking-wide">7310 651 940</a>
            ...
            <div>
              ...
              <ul className="space-y-4 text-[14px] font-medium">
                <li className="flex items-start">
                  ...
                  <a href={`tel:${CALL_NUMBER}`} className="text-white font-bold tracking-wide">7310 651 940</a>
                </li>
                <li className="flex items-start">
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 bg-[#00a859] hover:bg-[#00904d] text-white p-[14px] rounded-full shadow-2xl z-50 transition-transform transform hover:scale-110 flex items-center justify-center border-4 border-green-100/50"
      >
